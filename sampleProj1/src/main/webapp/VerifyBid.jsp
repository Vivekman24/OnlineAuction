	...
	<%
		...
		if (Double.parseDouble(amount) < increment) {
			...
			while (result3.next()) {
				...
				ps2.setString(1, "Alert! Higher bid placed for Auction " + auctionID + " for $" + curr_price+ ".");
			...
			while (result4.next()) {
				String insert2 = "INSERT IGNORE INTO Alert(message, alertTiming, endUserInfo)"
						+ "VALUES (?, ?, ?)";
				PreparedStatement ps2 = con.prepareStatement(insert2);
				ps2.setString(1, "Alert! Someone bid more than your upper limit for Auction " + auctionID + ".");
				ps2.setString(2, now.toString());
