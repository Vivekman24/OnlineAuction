...
<body>
 	...
 	<%
		...
		out.println("<th style='border: 1px solid #dddddd; text-align: left; padding: 8px;'>Description1</th>");
		out.println("<th style='border: 1px solid #dddddd; text-align: left; padding: 8px;'>Description2</th>");
		out.println("<th style='border: 1px solid #dddddd; text-align: left; padding: 8px;'>Description3</th>");
		out.println("</tr>");
		while (rs.next()) {
		    out.println("<tr>");
		...
		out.println("<tr><td>Engine Type:</td><td><input type='text' name='desc2' required/></td></tr>");
		out.println("<tr><td>Transmission:</td><td><input type='text' name='desc3' required/></td></tr>");
